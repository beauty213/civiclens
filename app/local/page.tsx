...
export default function LocalPage() {
  ...
  const [reportingPost, setReportingPost] = useState<LocalPost | null>(null);

  // Real-time privacy guardrail scanning
  const scanResult = scanContentSafety(`${newTitle} ${newContent}`);
    ...
    <div className="space-y-6 max-w-3xl mx-auto">
      ...
      {isCreating && (
        ...
        >
          ...
          {scanResult.hasWarnings && (
            <PrivacyWarningBanner warnings={scanResult.warnings} />
          )}
            ...
            <div className="flex items-center justify-between text-xs">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  title="Report Post for Privacy / Policy Violation"
                >
      ...
      <ReportContentModal
        ...
        contentTitle={reportingPost ? reportingPost.title : ''}
      />
    </div>
  );
}
